...
"""Script to run ROV Lab teleoperation with Isaac Lab environments."""
...
parser = argparse.ArgumentParser(description="ROV Lab teleoperation for Isaac Lab environments.")
...
def main():  # noqa: C901
    ...
    if args_cli.teleop_device == "keyboard":
        from rov_lab.devices import ROVKeyboard

        teleop_interface = ROVKeyboard(env, sensitivity=args_cli.sensitivity)
    else:
